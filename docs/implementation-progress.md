...
**Última actualización**: 2026-05-03 (PR0 completado, listo para PR)
...
|-----|--------|--------|-----|
| Ola 0 — PR0 Foundation | 🟢 LISTA PARA PR | `feat/api/foundation-pr0` | (a abrir) |
| Ola 1 — Config torneo (4 worktrees) | ⚪ Bloqueada por PR0 | — | — |
| Ola 2 — Plata (3 worktrees) | ⚪ Bloqueada por Ola 1 | — | — |
